def display_instructions():
    ...
    based on the courses you've taken, their grades, and corresponding credit units.
    ...
    2. Grade Format:
       - Use letter grades such as "A", "B", "C", etc. The app will automatically 
         convert these to the corresponding grade points based on the grading scale:
         - A = 5.0
         - B = 4.0
         - C = 3.0
         - D = 2.0
